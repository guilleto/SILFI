...
public class Usuario_EstadoPeriferico extends javax.swing.JFrame {
    ...
    public Usuario_EstadoPeriferico(String user, String id, String oldNombre, String oldDescripcion, String oldEquipo, String oldEstado, String oldDescripcionEstado) {
        this.user = user;
        this.id = id;
        ...
        System.out.println("Estado el equipo" + oldEquipo);
        jcEquipos.removeAllItems();
        this.jcEquipos.setModel(daoEquipo.llenar_ComboEstadoEquipo(oldEquipo));
        this.jcEstado.setModel(daoLab.llenar_ComboOldEstado(oldEstado));

        tfId_Periferico.setText(id);
        tfNombre_Periferico.setText(oldNombre);
    ...
    private Usuario_EstadoPeriferico() {
    }
    ...
    private void initComponents() {
        ...
        tfNombre_Periferico = new javax.swing.JTextField();
        ...
        jPanel1.add(btAñadir, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 640, 51, 59));
        ...
        jPanel1.add(jcEstado, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 515, 292, 30));

        tfId_Periferico.setEditable(false);
        jPanel1.add(tfId_Periferico, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 187, 170, 30));

        tfNombre_Periferico.setEditable(false);
        jPanel1.add(tfNombre_Periferico, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 275, 290, 30));

        tf_Descripcion.setEditable(false);
        jPanel1.add(tf_Descripcion, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 355, 290, 30));

        jPanel1.add(jcEquipos, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 435, 290, 30));
        ...
        jPanel1.add(tfDescripcionEstado, new org.netbeans.lib.awtextra.AbsoluteConstraints(82, 596, 290, 30));

        jLabel2.setFont(new java.awt.Font("Calibri", 3, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel2.setText("Estado");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 485, 290, -1));

        jLabel3.setFont(new java.awt.Font("Calibri", 3, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel3.setText("Equipo");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 403, 290, -1));

        jLabel4.setFont(new java.awt.Font("Calibri", 3, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel4.setText("ID PERIFERICO");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 151, 170, -1));

        jLabel5.setFont(new java.awt.Font("Calibri", 3, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel5.setText("Descripcion");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 320, 290, -1));

        jLabel6.setFont(new java.awt.Font("Calibri", 3, 18)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel6.setText("Nombre");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 250, 290, -1));

        jLabel7.setFont(new java.awt.Font("Calibri", 3, 24)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("ESTADO DEL PERIFERICO");
    ...
    private void btAñadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAñadirActionPerformed
        ...
        System.out.println("viejo: " + id + oldNombre + oldDescripcion + oldEquipo + oldEstado + oldDescripcionEstado);
        System.out.println("nuevo: " + id + tfNombre_Periferico.getText() + tf_Descripcion.getText() + equipo + estado + descripcionEstado);
        int resultSet;
        String sql = "UPDATE PERIFERICO "
                + " SET ID_PERIFERICO = '" + id + "' , "
                + " NOMBRE_PERIFERICO = '" + tfNombre_Periferico.getText() + "' , "
        ...
        try {
            ...
            JOptionPane.showMessageDialog(rootPane, "Se ha actualizado el Estado del Periferico : " + id + "", "Actualizacion del registro", JOptionPane.INFORMATION_MESSAGE);
        } catch (Exception e) {
        ...
        System.out.println("De vuelta al Perifericos " + id);
        Usuario_Perifericos obj = new Usuario_Perifericos(user, oldEquipo);
        obj.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Usuario_EstadoPeriferico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Usuario_EstadoPeriferico().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField tfNombre_Periferico;
