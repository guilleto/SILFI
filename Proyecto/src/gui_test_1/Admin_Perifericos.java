...
public class Admin_Perifericos extends javax.swing.JFrame {
    ...
    public Admin_Perifericos(String user, String oldEquipo) {
    ...
    public void actualizar() {
        ...
        if (fila == -1) {
            ...
            Admin_ActualizarPeriferico obj = new Admin_ActualizarPeriferico(user, id, oldNombre, oldDescripcion, oldEquipo);
            obj.setVisible(true);
        }
    ...
    private void btMantenimientoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btMantenimientoActionPerformed
        Admin_Mantenimiento obj = new Admin_Mantenimiento(user);
        obj.setVisible(true);
    ...
    private void btEstadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEstadoActionPerformed
        ...
        if (fila == -1) {
            ...
            Admin_EstadoPeriferico obj = new Admin_EstadoPeriferico(user, id, oldNombre, oldDescripcion, oldEquipo, oldEstado, oldDescripcionEstado);
            obj.setVisible(true);
            dispose();
        }
   ...
   Admin_AñadirPeriferico obj = new Admin_AñadirPeriferico(user, oldEquipo);
        obj.setVisible(true);
        obj.setLocationRelativeTo(null);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_Perifericos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_Perifericos().setVisible(true);
            }
        });
    }
