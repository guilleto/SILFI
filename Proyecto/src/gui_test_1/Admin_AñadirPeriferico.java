...
public class Admin_AñadirPeriferico extends javax.swing.JFrame {
    ...
    public Admin_AñadirPeriferico(String user, String oldEquipo) {
        initComponents();
    ...
    private Admin_AñadirPeriferico() {
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_AñadirPeriferico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_AñadirPeriferico().setVisible(true);
            }
        });
    }
