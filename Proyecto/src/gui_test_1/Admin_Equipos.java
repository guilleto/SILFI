...
public class Admin_Equipos extends javax.swing.JFrame {
    ...
    public Admin_Equipos(String user) {
    ...
    public void actualizar() {
        ...
        if (fila == -1) {
            ...
            Admin_ActualizarEquipo obj = new Admin_ActualizarEquipo(user, id, oldNombre, oldDescripcion, oldLab);
            obj.setVisible(true);
        }
    ...
    private void btAñadirEquiposActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAñadirEquiposActionPerformed
        Admin_AñadirEquipo obj = new Admin_AñadirEquipo(user);
        obj.setVisible(true);
        obj.setLocationRelativeTo(null);
  ...
  int fila = jtTablaEquipos.getSelectedRow();
        ...
        if (fila == -1) {
            ...
            Admin_EstadoEquipo obj = new Admin_EstadoEquipo(user, id, oldNombre, oldDescripcion, oldLab, oldEstado, oldDescripcionEstado);
            obj.setVisible(true);
            dispose();
        }        // TODO add your handling code here:
    ...
    private void btPerifericosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btPerifericosActionPerformed
     int fila = jtTablaEquipos.getSelectedRow();
        ...
        if (fila == -1) {
            ...
            Admin_Perifericos obj = new Admin_Perifericos(user, id);
            obj.setVisible(true);
            dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_Equipos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_Equipos().setVisible(true);
            }
        });
    }
