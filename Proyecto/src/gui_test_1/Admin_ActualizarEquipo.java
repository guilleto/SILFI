...
public class Admin_ActualizarEquipo extends javax.swing.JFrame {
    ...
    public Admin_ActualizarEquipo(String user, String id, String oldNombre, String oldDescripcion, String oldLab) {
        initComponents();
    ...
    private Admin_ActualizarEquipo() {
    }
    public void confirmar() {
        ...
        if (msj == JOptionPane.CLOSED_OPTION) {
            Admin_Equipos equipo = new Admin_Equipos(user);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_ActualizarEquipo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_ActualizarEquipo().setVisible(true);
            }
        });
    }
