...
public class Usuario_Mantenimiento extends javax.swing.JFrame {
    ...
    public Usuario_Mantenimiento(String user) {
    ...
    private void btAñadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAñadirActionPerformed
        ...
        if (rSCalendario.getDatoFecha() == null) {
            ...
            Usuario_ListaMantenimientos obj = new Usuario_ListaMantenimientos(resultados, user, fechaMant);
            obj.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Usuario_Mantenimiento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Usuario_Mantenimiento().setVisible(true);
            }
        });
    }
