...
public class Usuario_ActualizarPeriferico extends javax.swing.JFrame {
    ...
    public Usuario_ActualizarPeriferico(String user, String id, String oldNombre, String oldDescripcion, String oldEquipo) {
        initComponents();
    ...
    private Usuario_ActualizarPeriferico() {
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Usuario_ActualizarPeriferico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Usuario_ActualizarPeriferico().setVisible(true);
            }
        });
    }
