...
public class Usuario_ListaMantenimientosTable extends javax.swing.JFrame {
    ...
    public Usuario_ListaMantenimientosTable(String user, String mantenimientoFecha) {
    ...
    private Usuario_ListaMantenimientosTable() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Usuario_ListaMantenimientosTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Usuario_ListaMantenimientosTable().setVisible(true);
            }
        });
    }
