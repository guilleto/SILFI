...
public class Admin_EstadoEquipo extends javax.swing.JFrame {
    ...
    public Admin_EstadoEquipo(String user, String id, String oldNombre, String oldDescripcion, String oldLab, String oldEstado, String oldDescripcionEstado) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_EstadoEquipo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_EstadoEquipo().setVisible(true);
            }
        });
    }
