...
public class Admin_EstadoPeriferico extends javax.swing.JFrame {
    ...
    public Admin_EstadoPeriferico(String user, String id, String oldNombre, String oldDescripcion, String oldEquipo, String oldEstado, String oldDescripcionEstado) {
        this.user = user;
        this.id = id;
    ...
    private Admin_EstadoPeriferico() {
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_EstadoPeriferico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_EstadoPeriferico().setVisible(true);
            }
        });
    }
